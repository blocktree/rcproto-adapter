...
//RCPBlockScanner ontology的区块链扫描器
type RCPBlockScanner struct {
...
//NewRCPBlockScanner 创建区块链扫描器
func NewRCPBlockScanner(wm *WalletManager) *RCPBlockScanner {
	bs := RCPBlockScanner{
...
func (bs *RCPBlockScanner) SetRescanBlockHeight(height uint64) error {
	height = height - 1
	if height < 0 {
...
//ScanBlockTask 扫描任务
func (bs *RCPBlockScanner) ScanBlockTask() {
...
//ScanBlock 扫描指定高度区块
func (bs *RCPBlockScanner) ScanBlock(height uint64) error {
...
func (bs *RCPBlockScanner) scanBlock(height uint64) (*Block,error) {
	var (
		block *Block
		err error
	)
...
func (bs *RCPBlockScanner) ScanTxMemPool() {
...
func (bs *RCPBlockScanner) RescanFailedRecord() {
...
func (bs *RCPBlockScanner) newBlockNotify(block *Block, isFork bool) {
...
func (bs *RCPBlockScanner) BatchExtractTransaction(blockHeight uint64, blockHash string, txs []string, memPool bool) error {
	...
	if len(txs) == 0 {
		return nil//errors.New("BatchExtractTransaction block is nil.")
	}
...
func (bs *RCPBlockScanner) extractRuntime(producer chan ExtractResult, worker chan ExtractResult, quit chan struct{}) {
...
func (bs *RCPBlockScanner) ExtractTransaction(blockHeight uint64, blockHash string, txid string, scanAddressFunc openwallet.BlockScanAddressFunc, memPool bool) ExtractResult {
...
func (bs *RCPBlockScanner) extractTransaction(trx *Transaction, result *ExtractResult, scanAddressFunc openwallet.BlockScanAddressFunc) {
	var (
		success = true
	)
...
func (bs *RCPBlockScanner) newExtractDataNotify(height uint64, extractData map[string]*openwallet.TxExtractData) error {
...
func (bs *RCPBlockScanner) DeleteUnscanRecordNotFindTX() error {
...
//func (bs *RCPBlockScanner) SaveRechargeToWalletDB(height uint64, list []*openwallet.Recharge) error {
//
//	for _, r := range list {
//
...
func (bs *RCPBlockScanner) GetCurrentBlockHeader() (*openwallet.BlockHeader, error) {
	var (
...
func (bs *RCPBlockScanner) GetScannedBlockHeader() (*openwallet.BlockHeader, error) {
	...
	if blockHeight == 0 {
		blockHeight, err = bs.wm.GetBlockHeight()
		if err != nil {
			bs.wm.Log.Errorf("RCP GetBlockHeight failed,err = %v", err)
			return nil, err
		}
...
func (bs *RCPBlockScanner) GetScannedBlockHeight() uint64 {
	localHeight, _, _ := bs.wm.Blockscanner.GetLocalNewBlock()
	return localHeight
}

func (bs *RCPBlockScanner) ExtractTransactionData(txid string, scanTargetFunc openwallet.BlockScanTargetFunc) (map[string][]*openwallet.TxExtractData, error) {
...
//func (bs *RCPBlockScanner) DropRechargeRecords(accountID string) error {
//	bs.mu.RLock()
//	defer bs.mu.RUnlock()
//
...
//func (bs *RCPBlockScanner) DeleteRechargesByHeight(height uint64) error {
//
//	bs.mu.RLock()
//	defer bs.mu.RUnlock()
//
...
func (bs *RCPBlockScanner) GetSourceKeyByAddress(address string) (string, bool) {
	bs.Mu.RLock()
	defer bs.Mu.RUnlock()
...
// func (bs *RCPBlockScanner) GetWalletByAddress(address string) (*openwallet.Wallet, bool) {
// 	bs.mu.RLock()
// 	defer bs.mu.RUnlock()
...
func (bs *RCPBlockScanner) GetLocalNewBlock() (uint64, string, error) {
...
func (bs *RCPBlockScanner) SaveLocalNewBlock(blockHeight uint64, blockHash string) error {
...
func (bs *RCPBlockScanner) GetBalanceByAddress(address ...string) ([]*openwallet.Balance, error) {
...
func (bs *RCPBlockScanner) GetTransactionsByAddress(offset, limit int, coin openwallet.Coin, address ...string) ([]*openwallet.TxExtractData, error) {
...
//Run 运行
func (bs *RCPBlockScanner) Run() error {
...
////Stop 停止扫描
func (bs *RCPBlockScanner) Stop() error {
...
//Pause 暂停扫描
func (bs *RCPBlockScanner) Pause() error {
...
//Restart 继续扫描
func (bs *RCPBlockScanner) Restart() error {
...
func (bs *RCPBlockScanner) setupSocketIO() error {
...
//@optional
func (bs *RCPBlockScanner) SupportBlockchainDAI() bool {
	return true
}
...
func (bs *RCPBlockScanner) SaveLocalBlockHead(blockHeight uint32, blockHash string) error {
...
func (bs *RCPBlockScanner) GetLocalBlockHead() (uint32, string, error) {
...
func (bs *RCPBlockScanner) SaveLocalBlock(blockHeader *Block) error {
...
func (bs *RCPBlockScanner) GetLocalBlock(height uint32) (*Block, error) {
...
func (bs *RCPBlockScanner) SaveUnscanRecord(record *openwallet.UnscanRecord) error {
...
func (bs *RCPBlockScanner) DeleteUnscanRecord(height uint32) error {
...
func (bs *RCPBlockScanner) GetUnscanRecords() ([]*openwallet.UnscanRecord, error) {
